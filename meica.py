...
extopts.add_option('',"--qwarp",dest='qwarp',action='store_true',help="Nonlinear coregistration after affine (3dQWarp) to MNI (or --space) template ",default=False)
...
extopts.add_option('',"--space",dest='space',help="Path to specific standard space template for affine coregistration",default=False)
...
extopts.add_option('',"--no_despike",action="store_true",dest='no_despike',help="De-spike functional data. Default on, recommended.",default=False)
...
extopts.add_option('',"--smooth",dest='FWHM',help="Target dataset smoothness (3dBlurToFWHM). Default off. ex: -smooth 3mm ",default='0mm')
